#ifndef _COLLABCC_TEST_DRIVER_ASSERTION_H_INCLUDED_
#define _COLLABCC_TEST_DRIVER_ASSERTION_H_INCLUDED_
...
namespace test
{
        ...
        .../*user_msg args*/)
    {
        ...
        concat("[TEST] (", get_str_length("[TEST] ("));
...
#endif // _COLLABCC_TEST_DRIVER_ASSERTION_H_INCLUDED_
